...
import { ArrowRight, Building, Home, Key, MapPin } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Real Estate Digital Marketing | R.K Digital Media',
  description: 'Builders, developers, and brokers. Lead generation for residential & commercial projects. Local SEO, Google Ads, portal optimization, and CRM.',
};
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center bg-[var(--rkd-bg)] grid-pattern">
          <div className="max-w-[80rem] mx-auto px-4 md:px-6 text-center">
            ...
            <h1 className="font-montserrat font-black text-[var(--rkd-fg)] mb-6" style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)', lineHeight: '1.1' }}>
              Real Estate <span className="text-red-italic">Lead Generation</span>
            </h1>
            <p className="text-body-lg text-[var(--rkd-fg-muted)] max-w-2xl mx-auto" style={{ lineHeight: '1.7' }}>
              Builders, developers, and brokers. Lead generation for residential & commercial projects. Local SEO, Google Ads, portal optimization, and CRM.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-[80rem] mx-auto px-4 md:px-6">
            <div className="card-base max-w-3xl mx-auto">
              ...
              <div className="space-y-6 text-body text-[var(--rkd-fg-muted)]" style={{ lineHeight: '1.8' }}>
                <p>Project-specific landing pages with unit mix, pricing, floor plans, virtual tours, and booking forms.</p>
                <p>Google Ads targeting "2 BHK in Greater Noida West," "commercial space Sector 62" — high-intent, geo-fenced.</p>
                <p>99acres, MagicBricks, Housing.com optimization: listing SEO, lead capture, response time automation.</p>
                <p>GoHighLevel CRM: lead scoring (budget, timeline, BHK preference), auto-nurture, site visit scheduling.</p>
              </div>
              <div className="mt-8 pt-8 border-t border-[var(--rkd-border)] grid grid-cols-2 md:grid-cols-4 gap-4">
                {['Project Landing Pages', 'Geo-targeted Ads', 'Portal Optimization', 'Lead Scoring CRM'].map((tech) => (
